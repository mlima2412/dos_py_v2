...
export const contasPagarParcelasControllerUpdateMutationRequestSchema = z.lazy(
  () => updateContasPagarParcelasDtoSchema,
) as unknown as ToZod<ContasPagarParcelasControllerUpdateMutationRequest>

export const contasPagarParcelasControllerUpdateMutationResponseSchema = z.lazy(
  () => contasPagarParcelasControllerUpdate200Schema,
) as unknown as ToZod<ContasPagarParcelasControllerUpdateMutationResponse>

...
export const categoriaDespesasControllerFindOneQueryResponseSchema = z.lazy(() => categoriaDespesasControllerFindOne200Schema) as unknown as ToZod<CategoriaDespesasControllerFindOneQueryResponse>
...
export const usuarioParceiroControllerCreateMutationRequestSchema = z.lazy(
  () => createUsuarioParceiroDtoSchema,
) as unknown as ToZod<UsuarioParceiroControllerCreateMutationRequest>

export const usuarioParceiroControllerCreateMutationResponseSchema = z.lazy(
  () => usuarioParceiroControllerCreate201Schema,
) as unknown as ToZod<UsuarioParceiroControllerCreateMutationResponse>
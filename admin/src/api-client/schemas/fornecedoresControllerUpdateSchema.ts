 ...
 */
export const fornecedoresControllerUpdateMutationRequestSchema = z.lazy(
  () => updateFornecedorDtoSchema,
) as unknown as ToZod<FornecedoresControllerUpdateMutationRequest>

export const fornecedoresControllerUpdateMutationResponseSchema = z.lazy(
  () => fornecedoresControllerUpdate200Schema,
) as unknown as ToZod<FornecedoresControllerUpdateMutationResponse>

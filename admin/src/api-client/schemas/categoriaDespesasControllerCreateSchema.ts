...
export const categoriaDespesasControllerCreateMutationRequestSchema = z.lazy(
  () => createCategoriaDespesasDtoSchema,
) as unknown as ToZod<CategoriaDespesasControllerCreateMutationRequest>

export const categoriaDespesasControllerCreateMutationResponseSchema = z.lazy(
  () => categoriaDespesasControllerCreate201Schema,
) as unknown as ToZod<CategoriaDespesasControllerCreateMutationResponse>

...
"nome": z.optional(z.coerce.string().max(255).describe("Nome do produto")),
...
"precoVenda": z.optional(z.coerce.number().describe("Preço de venda do produto")),
"consignado": z.optional(z.boolean().default(false).describe("Se o produto é consignado")),
...
"ativo": z.optional(z.boolean().default(true).describe("Status ativo do produto")),
"dataCadastro": z.optional(z.string().datetime().describe("Data de cadastro do produto"))
    }) as unknown as z.ZodType<UpdateProdutoDto>
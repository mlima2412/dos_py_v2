 ...
 */
export async function usuarioParceiroControllerCreate(
  data: UsuarioParceiroControllerCreateMutationRequest,
  config: Partial<RequestConfig<UsuarioParceiroControllerCreateMutationRequest>> & { client?: typeof fetch } = {},
) {
  ...
  const res = await request<
    UsuarioParceiroControllerCreateMutationResponse,
    ResponseErrorConfig<UsuarioParceiroControllerCreate400 | UsuarioParceiroControllerCreate404 | UsuarioParceiroControllerCreate409>,
    UsuarioParceiroControllerCreateMutationRequest
  >({ method: 'POST', url: `/usuario-parceiro`, data: requestData, ...requestConfig })
  return res.data
}
 ...
 * {@link /usuario-parceiro}
 */
export function useUsuarioParceiroControllerCreate<TContext>(
  options: {

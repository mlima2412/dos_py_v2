 ...
 * {@link /usuario-parceiro}
 */
export function useUsuarioParceiroControllerFindAllSuspense<
  TData = UsuarioParceiroControllerFindAllQueryResponse,
  TQueryKey extends QueryKey = UsuarioParceiroControllerFindAllSuspenseQueryKey,
>(
  options: {
    query?: Partial<UseSuspenseQueryOptions<UsuarioParceiroControllerFindAllQueryResponse, ResponseErrorConfig<Error>, TData, TQueryKey>> & {
      client?: QueryClient
    }

...
export const despesasRecorrentesControllerFindByFrequenciaQueryKey = (frequencia: DespesasRecorrentesControllerFindByFrequenciaPathParams['frequencia']) =>
 ...
 */
export async function despesasRecorrentesControllerFindByFrequencia(
...
export function despesasRecorrentesControllerFindByFrequenciaQueryOptions(
  frequencia: DespesasRecorrentesControllerFindByFrequenciaPathParams['frequencia'],
  config: Partial<RequestConfig> & { client?: typeof fetch } = {},
) {
 ...
 * {@link /despesas-recorrentes/frequencia/:frequencia}
 */
export function useDespesasRecorrentesControllerFindByFrequencia<
  ...
  TQueryKey extends QueryKey = DespesasRecorrentesControllerFindByFrequenciaQueryKey,
>(
  frequencia: DespesasRecorrentesControllerFindByFrequenciaPathParams['frequencia'],
  options: {
    query?: Partial<
  ...
  const query = useQuery(
    ...
    queryClient,
  ) as UseQueryResult<TData, ResponseErrorConfig<DespesasRecorrentesControllerFindByFrequencia401>> & { queryKey: TQueryKey }

 ...
 */
export async function parceirosControllerUpdate(
  publicId: ParceirosControllerUpdatePathParams['publicId'],
  data?: ParceirosControllerUpdateMutationRequest,
  config: Partial<RequestConfig<ParceirosControllerUpdateMutationRequest>> & { client?: typeof fetch } = {},
) {
  ...
  const res = await request<
    ParceirosControllerUpdateMutationResponse,
    ResponseErrorConfig<ParceirosControllerUpdate404 | ParceirosControllerUpdate409>,
    ParceirosControllerUpdateMutationRequest
  >({ method: 'PATCH', url: `/parceiros/${publicId}`, data: requestData, ...requestConfig })
  return res.data
}
 ...
 * {@link /parceiros/:publicId}
 */
export function useParceirosControllerUpdate<TContext>(
  options: {
    mutation?: UseMutationOptions<
      ParceirosControllerUpdateMutationResponse,
      ResponseErrorConfig<ParceirosControllerUpdate404 | ParceirosControllerUpdate409>,
      { publicId: ParceirosControllerUpdatePathParams['publicId']; data?: ParceirosControllerUpdateMutationRequest },
      TContext
    > & { client?: QueryClient }

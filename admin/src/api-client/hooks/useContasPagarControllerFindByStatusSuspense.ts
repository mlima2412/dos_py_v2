...
export const contasPagarControllerFindByStatusSuspenseQueryKey = (pago: ContasPagarControllerFindByStatusPathParams['pago']) =>
 ...
 */
export async function contasPagarControllerFindByStatusSuspense(
...
export function contasPagarControllerFindByStatusSuspenseQueryOptions(
  pago: ContasPagarControllerFindByStatusPathParams['pago'],
  config: Partial<RequestConfig> & { client?: typeof fetch } = {},
) {
 ...
 * {@link /contas-pagar/status/:pago}
 */
export function useContasPagarControllerFindByStatusSuspense<
  TData = ContasPagarControllerFindByStatusQueryResponse,
  TQueryKey extends QueryKey = ContasPagarControllerFindByStatusSuspenseQueryKey,
>(
  pago: ContasPagarControllerFindByStatusPathParams['pago'],
  options: {
    query?: Partial<UseSuspenseQueryOptions<ContasPagarControllerFindByStatusQueryResponse, ResponseErrorConfig<Error>, TData, TQueryKey>> & {
      client?: QueryClient
    }

 ...
 */
export async function currencyControllerRemove(
  publicId: CurrencyControllerRemovePathParams['publicId'],
  ...
  const res = await request<
    CurrencyControllerRemoveMutationResponse,
    ResponseErrorConfig<CurrencyControllerRemove401 | CurrencyControllerRemove404 | CurrencyControllerRemove409>,
    unknown
  >({ method: 'DELETE', url: `/currency/${publicId}`, ...requestConfig })
  return res.data
}
 ...
 * {@link /currency/:publicId}
 */
export function useCurrencyControllerRemove<TContext>(
  options: {

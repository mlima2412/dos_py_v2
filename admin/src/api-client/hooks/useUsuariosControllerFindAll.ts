...
export function useUsuariosControllerFindAll<
  ...
  TQueryData = UsuariosControllerFindAllQueryResponse,
  TQueryKey extends QueryKey = UsuariosControllerFindAllQueryKey,
>(
  options: {
    query?: Partial<QueryObserverOptions<UsuariosControllerFindAllQueryResponse, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>> & {
      client?: QueryClient
    }

...
export function perfisControllerFindOneQueryOptions(
 ...
 * {@link /perfis/:id}
 */
export function usePerfisControllerFindOne<
  TData = PerfisControllerFindOneQueryResponse,
  TQueryData = PerfisControllerFindOneQueryResponse,
  TQueryKey extends QueryKey = PerfisControllerFindOneQueryKey,
>(
  id: PerfisControllerFindOnePathParams['id'],
  options: {
    query?: Partial<
      QueryObserverOptions<PerfisControllerFindOneQueryResponse, ResponseErrorConfig<PerfisControllerFindOne404>, TData, TQueryData, TQueryKey>
    > & { client?: QueryClient }
  ...
  const query = useQuery(
    ...
    queryClient,
  ) as UseQueryResult<TData, ResponseErrorConfig<PerfisControllerFindOne404>> & { queryKey: TQueryKey }

...
export const despesasRecorrentesControllerFindBySubCategoriaSuspenseQueryKey = (
 ...
 */
export async function despesasRecorrentesControllerFindBySubCategoriaSuspense(
  subCategoriaId: DespesasRecorrentesControllerFindBySubCategoriaPathParams['subCategoriaId'],
...
export function despesasRecorrentesControllerFindBySubCategoriaSuspenseQueryOptions(
  subCategoriaId: DespesasRecorrentesControllerFindBySubCategoriaPathParams['subCategoriaId'],
  config: Partial<RequestConfig> & { client?: typeof fetch } = {},
) {
...
export function useDespesasRecorrentesControllerFindBySubCategoriaSuspense<
  ...
  TQueryKey extends QueryKey = DespesasRecorrentesControllerFindBySubCategoriaSuspenseQueryKey,
>(
  subCategoriaId: DespesasRecorrentesControllerFindBySubCategoriaPathParams['subCategoriaId'],
  options: {
    query?: Partial<
  ...
  const query = useSuspenseQuery(
    ...
    queryClient,
  ) as UseSuspenseQueryResult<TData, ResponseErrorConfig<DespesasRecorrentesControllerFindBySubCategoria401>> & { queryKey: TQueryKey }

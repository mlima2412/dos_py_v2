...
export const usuariosControllerFindPaginatedSuspenseQueryKey = (params: UsuariosControllerFindPaginatedQueryParams) =>
 ...
 */
export async function usuariosControllerFindPaginatedSuspense(
...
export function usuariosControllerFindPaginatedSuspenseQueryOptions(
  params: UsuariosControllerFindPaginatedQueryParams,
  config: Partial<RequestConfig> & { client?: typeof fetch } = {},
) {
 ...
 * {@link /usuarios/paginated}
 */
export function useUsuariosControllerFindPaginatedSuspense<
  TData = UsuariosControllerFindPaginatedQueryResponse,
  TQueryKey extends QueryKey = UsuariosControllerFindPaginatedSuspenseQueryKey,
>(
  params: UsuariosControllerFindPaginatedQueryParams,
  options: {
    query?: Partial<UseSuspenseQueryOptions<UsuariosControllerFindPaginatedQueryResponse, ResponseErrorConfig<Error>, TData, TQueryKey>> & {
      client?: QueryClient
    }

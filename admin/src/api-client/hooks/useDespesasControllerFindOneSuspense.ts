...
export const despesasControllerFindOneSuspenseQueryKey = (publicId: DespesasControllerFindOnePathParams['publicId']) =>
 ...
 * {@link /despesas/:publicId}
 */
export function useDespesasControllerFindOneSuspense<
...
>(
  ...
  const query = useSuspenseQuery(
    ...
    queryClient,
  ) as UseSuspenseQueryResult<TData, ResponseErrorConfig<DespesasControllerFindOne404>> & { queryKey: TQueryKey }

 ...
 */
export async function subCategoriaDespesaControllerUpdate(
  id: SubCategoriaDespesaControllerUpdatePathParams['id'],
  data?: SubCategoriaDespesaControllerUpdateMutationRequest,
  config: Partial<RequestConfig<SubCategoriaDespesaControllerUpdateMutationRequest>> & { client?: typeof fetch } = {},
) {
  ...
  const res = await request<
    SubCategoriaDespesaControllerUpdateMutationResponse,
    ResponseErrorConfig<SubCategoriaDespesaControllerUpdate401 | SubCategoriaDespesaControllerUpdate404 | SubCategoriaDespesaControllerUpdate409>,
    SubCategoriaDespesaControllerUpdateMutationRequest
  >({ method: 'PATCH', url: `/subcategoria-despesa/${id}`, data: requestData, ...requestConfig })
  return res.data
}
 ...
 * {@link /subcategoria-despesa/:id}
 */
export function useSubCategoriaDespesaControllerUpdate<TContext>(
  options: {
    mutation?: UseMutationOptions<
      SubCategoriaDespesaControllerUpdateMutationResponse,
      ResponseErrorConfig<SubCategoriaDespesaControllerUpdate401 | SubCategoriaDespesaControllerUpdate404 | SubCategoriaDespesaControllerUpdate409>,
      { id: SubCategoriaDespesaControllerUpdatePathParams['id']; data?: SubCategoriaDespesaControllerUpdateMutationRequest },
      TContext
    > & { client?: QueryClient }

...
export async function subCategoriaDespesaControllerFindAllSuspense(config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<SubCategoriaDespesaControllerFindAllQueryResponse, ResponseErrorConfig<SubCategoriaDespesaControllerFindAll401>, unknown>({
    method: 'GET',
    url: `/subcategoria-despesa`,
    ...requestConfig,
  })
  return res.data
}
...
export function subCategoriaDespesaControllerFindAllSuspenseQueryOptions(config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  return queryOptions<
    SubCategoriaDespesaControllerFindAllQueryResponse,
    ResponseErrorConfig<SubCategoriaDespesaControllerFindAll401>,
    SubCategoriaDespesaControllerFindAllQueryResponse,
    typeof queryKey
  >({
    queryKey,
 ...
 * {@link /subcategoria-despesa}
 */
export function useSubCategoriaDespesaControllerFindAllSuspense<
  TData = SubCategoriaDespesaControllerFindAllQueryResponse,
  TQueryKey extends QueryKey = SubCategoriaDespesaControllerFindAllSuspenseQueryKey,
>(
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<SubCategoriaDespesaControllerFindAllQueryResponse, ResponseErrorConfig<SubCategoriaDespesaControllerFindAll401>, TData, TQueryKey>
    > & { client?: QueryClient }
  ...
  const query = useSuspenseQuery(
    ...
    queryClient,
  ) as UseSuspenseQueryResult<TData, ResponseErrorConfig<SubCategoriaDespesaControllerFindAll401>> & { queryKey: TQueryKey }

...
export async function parceirosControllerFindAll(config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<ParceirosControllerFindAllQueryResponse, ResponseErrorConfig<Error>, unknown>({
    method: 'GET',
    url: `/parceiros`,
    ...requestConfig,
  })
 ...
 * {@link /parceiros}
 */
export function useParceirosControllerFindAll<
  TData = ParceirosControllerFindAllQueryResponse,
  TQueryData = ParceirosControllerFindAllQueryResponse,
  TQueryKey extends QueryKey = ParceirosControllerFindAllQueryKey,
>(
  options: {
    query?: Partial<QueryObserverOptions<ParceirosControllerFindAllQueryResponse, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>> & {
      client?: QueryClient
    }

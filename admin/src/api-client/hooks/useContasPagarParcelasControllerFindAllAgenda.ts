...
export const contasPagarParcelasControllerFindAllAgendaQueryKey = (parceiroId: ContasPagarParcelasControllerFindAllAgendaPathParams['parceiroId']) =>
 ...
 */
export async function contasPagarParcelasControllerFindAllAgenda(
...
export function contasPagarParcelasControllerFindAllAgendaQueryOptions(
  parceiroId: ContasPagarParcelasControllerFindAllAgendaPathParams['parceiroId'],
  config: Partial<RequestConfig> & { client?: typeof fetch } = {},
) {
 ...
 * {@link /contas-pagar-parcelas/agenda/:parceiroId}
 */
export function useContasPagarParcelasControllerFindAllAgenda<
...
>(
  parceiroId: ContasPagarParcelasControllerFindAllAgendaPathParams['parceiroId'],
  options: {
    query?: Partial<QueryObserverOptions<ContasPagarParcelasControllerFindAllAgendaQueryResponse, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>> & {
      client?: QueryClient
    }

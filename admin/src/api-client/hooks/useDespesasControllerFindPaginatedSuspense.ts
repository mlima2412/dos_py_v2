...
export const despesasControllerFindPaginatedSuspenseQueryKey = (params?: DespesasControllerFindPaginatedQueryParams) =>   [{ url: '/despesas/paginated' }, ...(params ? [params] : [])] as const
 ...
 */
export async function despesasControllerFindPaginatedSuspense(params?: DespesasControllerFindPaginatedQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
...
export function despesasControllerFindPaginatedSuspenseQueryOptions(params?: DespesasControllerFindPaginatedQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
 ...
 * {@link /despesas/paginated}
 */
export function useDespesasControllerFindPaginatedSuspense<TData = DespesasControllerFindPaginatedQueryResponse, TQueryKey extends QueryKey = DespesasControllerFindPaginatedSuspenseQueryKey>(params?: DespesasControllerFindPaginatedQueryParams, options: 
  {
    query?: Partial<UseSuspenseQueryOptions<DespesasControllerFindPaginatedQueryResponse, ResponseErrorConfig<Error>, TData, TQueryKey>> & { client?: QueryClient },

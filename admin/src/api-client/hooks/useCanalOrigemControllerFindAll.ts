...
export async function canalOrigemControllerFindAll(config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<CanalOrigemControllerFindAllQueryResponse, ResponseErrorConfig<Error>, unknown>({
    method: 'GET',
    url: `/canal-origem`,
    ...requestConfig,
  })
 ...
 * {@link /canal-origem}
 */
export function useCanalOrigemControllerFindAll<
  TData = CanalOrigemControllerFindAllQueryResponse,
  TQueryData = CanalOrigemControllerFindAllQueryResponse,
  TQueryKey extends QueryKey = CanalOrigemControllerFindAllQueryKey,
>(
  options: {
    query?: Partial<QueryObserverOptions<CanalOrigemControllerFindAllQueryResponse, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>> & {
      client?: QueryClient
    }

 ...
 */
export async function despesasRecorrentesControllerUpdate(
  publicId: DespesasRecorrentesControllerUpdatePathParams['publicId'],
  data?: DespesasRecorrentesControllerUpdateMutationRequest,
  config: Partial<RequestConfig<DespesasRecorrentesControllerUpdateMutationRequest>> & { client?: typeof fetch } = {},
) {
  ...
  const res = await request<
    DespesasRecorrentesControllerUpdateMutationResponse,
    ResponseErrorConfig<DespesasRecorrentesControllerUpdate400 | DespesasRecorrentesControllerUpdate401 | DespesasRecorrentesControllerUpdate404>,
    DespesasRecorrentesControllerUpdateMutationRequest
  >({ method: 'PATCH', url: `/despesas-recorrentes/${publicId}`, data: requestData, ...requestConfig })
  return res.data
}
 ...
 * {@link /despesas-recorrentes/:publicId}
 */
export function useDespesasRecorrentesControllerUpdate<TContext>(
  options: {
    mutation?: UseMutationOptions<
      DespesasRecorrentesControllerUpdateMutationResponse,
      ResponseErrorConfig<DespesasRecorrentesControllerUpdate400 | DespesasRecorrentesControllerUpdate401 | DespesasRecorrentesControllerUpdate404>,
      { publicId: DespesasRecorrentesControllerUpdatePathParams['publicId']; data?: DespesasRecorrentesControllerUpdateMutationRequest },
      TContext
    > & { client?: QueryClient }

 ...
 * {@link /fornecedores}
 */
export async function fornecedoresControllerCreate(
  data: FornecedoresControllerCreateMutationRequest,
  config: Partial<RequestConfig<FornecedoresControllerCreateMutationRequest>> & { client?: typeof fetch } = {},
) {
  ...
  const res = await request<
    FornecedoresControllerCreateMutationResponse,
    ResponseErrorConfig<FornecedoresControllerCreate409>,
    FornecedoresControllerCreateMutationRequest
  >({ method: 'POST', url: `/fornecedores`, data: requestData, ...requestConfig })
  return res.data
}
 ...
 * {@link /fornecedores}
 */
export function useFornecedoresControllerCreate<TContext>(
  options: {

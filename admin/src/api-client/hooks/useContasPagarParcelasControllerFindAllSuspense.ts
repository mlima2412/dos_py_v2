 ...
 * {@link /contas-pagar-parcelas}
 */
export function useContasPagarParcelasControllerFindAllSuspense<
  TData = ContasPagarParcelasControllerFindAllQueryResponse,
  TQueryKey extends QueryKey = ContasPagarParcelasControllerFindAllSuspenseQueryKey,
>(
  options: {
    query?: Partial<UseSuspenseQueryOptions<ContasPagarParcelasControllerFindAllQueryResponse, ResponseErrorConfig<Error>, TData, TQueryKey>> & {
      client?: QueryClient
    }

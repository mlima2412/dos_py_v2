 ...
 */
export async function despesasRecorrentesControllerCreate(
  data: DespesasRecorrentesControllerCreateMutationRequest,
  config: Partial<RequestConfig<DespesasRecorrentesControllerCreateMutationRequest>> & { client?: typeof fetch } = {},
) {
  ...
  const res = await request<
    DespesasRecorrentesControllerCreateMutationResponse,
    ResponseErrorConfig<DespesasRecorrentesControllerCreate400 | DespesasRecorrentesControllerCreate401>,
    DespesasRecorrentesControllerCreateMutationRequest
  >({ method: 'POST', url: `/despesas-recorrentes`, data: requestData, ...requestConfig })
  return res.data
}
 ...
 * {@link /despesas-recorrentes}
 */
export function useDespesasRecorrentesControllerCreate<TContext>(
  options: {

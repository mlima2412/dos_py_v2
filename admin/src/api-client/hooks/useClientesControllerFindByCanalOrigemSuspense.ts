...
import type { ClientesControllerFindByCanalOrigemQueryResponse, ClientesControllerFindByCanalOrigemPathParams } from "../types/ClientesControllerFindByCanalOrigem.ts";

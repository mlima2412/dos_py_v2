...
export async function usuariosControllerInitializeSystem(config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<UsuariosControllerInitializeSystemMutationResponse, ResponseErrorConfig<Error>, unknown>({
    method: 'POST',
    url: `/usuarios/initialize-system`,
    ...requestConfig,
  })
  return res.data
}
 ...
 * {@link /usuarios/initialize-system}
 */
export function useUsuariosControllerInitializeSystem<TContext>(
  options: {

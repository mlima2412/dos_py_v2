...
export const SubCategoriaDespesaActions = ({ subcategoria }: SubCategoriaDespesaActionsProps) => {
  const { mutate: updateSubCategoria } = useSubCategoriaDespesaControllerUpdate();

...
export const useSubCategoriaDespesaColumns = (): ColumnDef<SubCategoriaDespesaItem>[] => {
  ...
  },
  {
    ...
    cell: ({ getValue }) => {
      ...
      return (
        ...
        >
          {ativo ? t('expenseSubtypes.columns.active') : t('expenseSubtypes.columns.inactive')}
        </span>
      );
    },
    meta: {
  ...
  },
  {
    id: 'actions',
    header: '',
    cell: ({ row }) => <SubCategoriaDespesaActions subcategoria={row.original} />,
    meta: {
      className: 'w-[100px]',
    },
  },

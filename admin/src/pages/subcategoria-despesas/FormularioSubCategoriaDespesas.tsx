...
const FormularioSubCategoriaDespesas: React.FC = () => {
	...
	} = useSubCategoriaDespesaControllerFindOne(Number(idSubCategoria), {
		query: {
				...
				<Breadcrumb>
					<BreadcrumbList>
						...
						<BreadcrumbItem>
							<BreadcrumbPage>
								{isEditing
									? t("expenseSubtypes.editSubcategory")
										...
										render={({ field }) => (
											...
											>
												<SelectTrigger>
													<SelectValue
														placeholder={t(
															"expenseSubtypes.categoryPlaceholder"
														)}
													/>
												</SelectTrigger>
												<SelectContent>

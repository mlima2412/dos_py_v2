...
import { usePasswordResetControllerResetPassword, usePasswordResetControllerValidateToken } from '@/api-client';
...
function ResetPassword() {
  ...
  const { data: tokenValidation, isLoading: validatingToken, error: tokenError } = usePasswordResetControllerValidateToken(
    { token: token || '' },
    {
      query: {
        enabled: !!token,
          ...
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              <CardTitle className="text-xl font-bold">
                {success ? t('resetPassword.success') : t('resetPassword.title')}
              </CardTitle>
              ...
              {!success ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    ...
                    variant="outline"
                    className="w-full"
                    disabled={resetPasswordMutation.isPending || !tokenValidation}
                  >

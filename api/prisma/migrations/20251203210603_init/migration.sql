...
-- CreateEnum
CREATE TYPE "public"."TipoDRE" AS ENUM ('RECEITA', 'DEDUCAO', 'CUSTO', 'DESPESA');
...
-- CreateTable
CREATE TABLE "public"."grupo_dre" (
    "id" SERIAL NOT NULL,
    "public_id" TEXT NOT NULL,
    "codigo" TEXT NOT NULL,
    "nome" TEXT NOT NULL,
    "tipo" "public"."TipoDRE" NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."regra_lancamento_automatico" (
    "id" SERIAL NOT NULL,
    "public_id" TEXT NOT NULL,
    ...
    "divisor" DECIMAL(12,3),
    "requer_fatura" BOOLEAN NOT NULL DEFAULT false,
    "ativo" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "public"."lancamento_dre" (
    "id" SERIAL NOT NULL,
    "public_id" TEXT NOT NULL,
    "conta_dre_id" INTEGER NOT NULL,
    "parceiro_id" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."rollup_despesas_mensais_dre" (
    "parceiro_id" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "grupo_dre_public_id_key" ON "public"."grupo_dre"("public_id");

-- CreateIndex
CREATE UNIQUE INDEX "grupo_dre_codigo_key" ON "public"."grupo_dre"("codigo");

-- CreateIndex
CREATE UNIQUE INDEX "conta_dre_public_id_key" ON "public"."conta_dre"("public_id");

-- CreateIndex
CREATE UNIQUE INDEX "conta_dre_parceiro_id_grupo_id_nome_key" ON "public"."conta_dre"("parceiro_id", "grupo_id", "nome");

-- CreateIndex
CREATE UNIQUE INDEX "imposto_public_id_key" ON "public"."imposto"("public_id");

-- CreateIndex
CREATE UNIQUE INDEX "imposto_parceiro_id_sigla_key" ON "public"."imposto"("parceiro_id", "sigla");

-- CreateIndex
CREATE UNIQUE INDEX "regra_lancamento_automatico_public_id_key" ON "public"."regra_lancamento_automatico"("public_id");

-- CreateIndex
CREATE UNIQUE INDEX "lancamento_dre_public_id_key" ON "public"."lancamento_dre"("public_id");
...
-- AddForeignKey
ALTER TABLE "public"."despesa" ADD CONSTRAINT "despesa_sub_categoria_id_fkey" FOREIGN KEY ("sub_categoria_id") REFERENCES "public"."subcategoria_despesa"("subcategoria_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."despesa" ADD CONSTRAINT "despesa_conta_dre_id_fkey" FOREIGN KEY ("conta_dre_id") REFERENCES "public"."conta_dre"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."despesa_recorrente" ADD CONSTRAINT "despesa_recorrente_sub_categoria_id_fkey" FOREIGN KEY ("sub_categoria_id") REFERENCES "public"."subcategoria_despesa"("subcategoria_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."despesa_recorrente" ADD CONSTRAINT "despesa_recorrente_conta_dre_id_fkey" FOREIGN KEY ("conta_dre_id") REFERENCES "public"."conta_dre"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."conta_dre" ADD CONSTRAINT "conta_dre_grupo_id_fkey" FOREIGN KEY ("grupo_id") REFERENCES "public"."grupo_dre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."regra_lancamento_automatico" ADD CONSTRAINT "regra_lancamento_automatico_conta_dre_id_fkey" FOREIGN KEY ("conta_dre_id") REFERENCES "public"."conta_dre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."regra_lancamento_automatico" ADD CONSTRAINT "regra_lancamento_automatico_imposto_id_fkey" FOREIGN KEY ("imposto_id") REFERENCES "public"."imposto"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."lancamento_dre" ADD CONSTRAINT "lancamento_dre_conta_dre_id_fkey" FOREIGN KEY ("conta_dre_id") REFERENCES "public"."conta_dre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."rollup_despesas_mensais_dre" ADD CONSTRAINT "rollup_despesas_mensais_dre_parceiro_id_fkey" FOREIGN KEY ("parceiro_id") REFERENCES "public"."parceiro"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."rollup_despesas_mensais_dre" ADD CONSTRAINT "rollup_despesas_mensais_dre_grupo_dre_id_fkey" FOREIGN KEY ("grupo_dre_id") REFERENCES "public"."grupo_dre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."rollup_despesas_mensais_dre" ADD CONSTRAINT "rollup_despesas_mensais_dre_conta_dre_id_fkey" FOREIGN KEY ("conta_dre_id") REFERENCES "public"."conta_dre"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."forma_pagamento" ADD CONSTRAINT "forma_pagamento_conta_dre_id_fkey" FOREIGN KEY ("conta_dre_id") REFERENCES "public"."conta_dre"("id") ON DELETE SET NULL ON UPDATE CASCADE;

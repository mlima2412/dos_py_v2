...
export class ClientesService {
  ...
  async create(createClienteDto: CreateClienteDto): Promise<any> {
    ...
    const cliente = await this.prisma.cliente.create({
      data: {
        ...
        ruccnpjSecundario: clienteEntity.ruccnpjSecundario || null,
        nomeFatura: clienteEntity.nomeFatura || null,
  ...
  async update(
    ...
    const cleanedData = {
      ...
      ruccnpjSecundario: updateClienteDto.ruccnpjSecundario || null,
      nomeFatura: updateClienteDto.nomeFatura || null,
